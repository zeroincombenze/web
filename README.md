...
[web_advanced_search_x2x](web_advanced_search_x2x/) | 10.0.2.0.0 | :repeat: | Use a search widget in advanced search for x2x fields
...
[web_favicon](web_favicon/) | 10.0.1.0.0 | :repeat: | Allows to set a custom shortcut icon (aka favicon)
[web_hide_db_manager_link](web_hide_db_manager_link/) | 10.0.1.0.0 | :repeat: | Hide link to database manager in login screen
...
[web_m2x_options](web_m2x_options/) | 10.0.1.0.0 | :repeat: | web_m2x_options
...
[web_widget_x2many_2d_matrix](web_widget_x2many_2d_matrix/) | 10.0.1.0.0 | 10.0.1.0.1 | Show list fields as a matrix
[web_x2many_delete_all](web_x2many_delete_all/) | 10.0.1.0.0 | :repeat: | Adds a button to x2many fields that removes all linked records
...
[web_widget_float_formula](web_widget_float_formula/) | 9.0.1.0.0 (unported) | :repeat: | Allow use of simple formulas in float fields
