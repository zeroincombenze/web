[![Build Status](https://travis-ci.org/zeroincombenze/really-simple-color-picker.svg?branch=7.0)](https://travis-ci.org/zeroincombenze/really-simple-color-picker)
